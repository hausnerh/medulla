...
{   
    ...
    {
        return particle_multiplicity(obj, 2, pvars::kPhoton, params) == 2;
    }
    ...
    {
        return particle_multiplicity(obj, 1, pvars::kPhoton, params) == 1;
    }
    ...
    {
        return particle_multiplicity(obj, 1, pvars::kElectron, params) == 1;
    }
    ...
    {
        return particle_multiplicity(obj, 1, pvars::kMuon, params) == 1;
    }
    ...
    {
        return particle_multiplicity(obj, 1, pvars::kPion, params) == 1;
    }
    ...
    {
        return particle_multiplicity(obj, 1, pvars::kProton, params) == 1;
    }
    ...
    {
        return particle_multiplicity(obj, 0, pvars::kPhoton, params) == 0;
    }
    ...
    {
        return particle_multiplicity(obj, 0, pvars::kElectron, params) == 0;
    }
    ...
    {
        return particle_multiplicity(obj, 0, pvars::kMuon, params) == 0;
    }
    ...
    {
        return particle_multiplicity(obj, 0, pvars::kPion, params) == 0;
    }
    ...
    {
        return particle_multiplicity(obj, 0, pvars::kProton, params) == 0;
    }
