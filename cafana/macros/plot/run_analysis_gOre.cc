                 ...
                 const bool& deltaResSwitch)
{
  ...
  //std::cout << "//*** DIRECTIONAL SPREAD CUT ***//" << std::endl;
...
int main(int argc, char* argv[])
{
  ...
  ret += try_call("Run gOre Analysis", run_analysis, treeDir, sample, "gOre", "gOre", false);
  //ret += try_call("Run gOre Analysis", run_analysis, treeDir, sample, "gOre", "gOre", true);
  return ret;
}
